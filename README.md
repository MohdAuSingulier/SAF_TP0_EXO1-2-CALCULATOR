...
# TP0 - Introduction à Java et création d'une Calculatrice
...
Ce fichier servait à corriger un programme qui ne fonctionnait pas. J'ai analysé une boucle `while` pour corriger deux grosses erreurs : une condition inversée (`<=` au lieu de `>=`) et l'oubli de l'incrémentation du compteur (`ind++`), ce qui créait une boucle infinie. Cela m'a appris à bien tracer mes variables pour éviter les plantages.
